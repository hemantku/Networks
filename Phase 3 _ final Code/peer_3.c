/* This a peer_3 UDP code for peer-to-peer authentication. Last Modified on :11/5/2013 at 10:14 AM
...
int main(void)
{
		...
		if ((rv = getaddrinfo("nunki.usc.edu",PEER_3_PORT, &hints, &servinfo)) != 0) 
		{
			fprintf(stderr, "getaddrinfo: %s\n", gai_strerror(rv));
			return 1;
		}
